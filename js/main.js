...
const TICKET_TYPES = {
  award: {
    ...
    price: 4499,
    priceNote: "per category · up to 5 categories",
  },
  delegate: {
    label: "Delegate Pass",
    price: 4999,
    priceNote: "per person · full-day access",
  },
  startup: {
    label: "PitchPower",
    price: 5000,
    priceNote: "per startup · includes delegate access",
  },
};
...
const ALL_CATS_FLAT = AWARD_SECTORS.flatMap((s) =>
  s.cats.map((c) => ({ name: c, type: s.type })),
);

const JURY = [
  {
    i: "SS",
    name: "Ms. Shweta Shalini",
    role: "Chief Evangelist, Billennium Divas · TEDx Speaker",
    chair: true,
    img: "https://www.womenpowersummit.in/assets/img/new_images/SS.jpg",
  },
  {
    i: "AT",
    name: "Mr. Ajay Thakur",
    role: "CEO & Managing Partner, TGI SME Capital Advisors LLP",
    img: "https://www.womenpowersummit.in/assets/img/new_images/AT.jpeg",
  },
  {
    i: "MS",
    name: "Mr. Mahavir Pratap Sharma",
    role: "General Partner, Swishin Ventures",
    img: "https://www.womenpowersummit.in/assets/img/new_images/MS.jpg",
  },
  {
    i: "RR",
    name: "Mr. Ramanan Ramanathan",
    role: "Mission Director, Atal Innovation Mission",
    img: "https://www.womenpowersummit.in/assets/img/new_images/RR.png",
  },
  {
    i: "TC",
    name: "Ms. Tanya Chaitanya",
    role: "CEO, Her Circle · President Digital & Diversity, Reliance",
    img: "https://www.womenpowersummit.in/assets/img/new_images/TC.jpg",
  },
  {
    i: "AS",
    name: "Mr. Amit Singal",
    role: "Founding Partner, Fluid Ventures",
    img: "https://www.womenpowersummit.in/assets/img/new_images/AS.jpg",
  },
  {
    i: "SG",
    name: "Ms. Sonia Sharma Gupta",
    role: "Co-Founder & Head IR, IvyCap Ventures",
    img: "https://www.womenpowersummit.in/assets/img/new_images/SSG.jpeg",
  },
  {
    i: "CO",
    name: "Mr. Chintan Oza",
    role: "Founder, Anantam Ecosystems",
    img: "https://www.womenpowersummit.in/assets/img/new_images/CO.png",
  },
  {
    i: "RB",
    name: "Ms. Rachana Bhusari",
    role: "CCO & Head Legal, ICICIDirect",
    img: "https://www.womenpowersummit.in/assets/img/new_images/RB.jpg",
  },
  {
    i: "AB",
    name: "Mr. Adhiraj Banerjee",
    role: "Founder, OpenDelta",
    img: "https://www.womenpowersummit.in/assets/img/new_images/AB.jpg",
  },
  {
    i: "JT",
    name: "Ms. Jyoti M Tiwari",
    role: "Founder & CEO, Ingenious Works",
    img: "https://www.womenpowersummit.in/assets/img/new_images/JT.jpeg",
  },
  {
    i: "DM",
    name: "Ms. Divya Momaya",
    role: "Founder, MentorMyBoard",
    img: "https://www.womenpowersummit.in/assets/img/new_images/DM.jpg",
  },
];
...
const SCHEDULE = [
  {
    ...
    desc: "Check-in, tea & coffee, welcome networking for all delegates",
  },
  {
    time: "10:30 – 10:35 AM",
    title: "Opening Ceremony & Lamp Lighting",
    desc: "Chief Guest, Guest of Honour & Dignitaries. Welcome address by organisers.",
  },
  {
    time: "10:35 – 10:50 AM",
    title: "Keynote Address",
    desc: "By the Chief Guest",
  },
  { time: "10:50 – 11:00 AM", title: "Address by Guest of Honour", desc: "" },
  {
    time: "11:00 – 11:30 AM",
    title: "Fireside Chat",
    desc: '"How can we Unleash the Power of Women Entrepreneurs?"',
  },
  {
    time: "11:30 AM – 12:00",
    title: "Awards Ceremony — Set 1",
    desc: "Felicitation of the first batch of Women Power Award Winners 2026",
  },
  {
    time: "12:00 – 12:15 PM",
    title: "Empower Track 1",
    desc: "Bridging the Digital Divide & Increasing Access for Women Entrepreneurs",
  },
  {
    time: "12:15 – 01:00 PM",
    title: "Panel Discussion 1",
    desc: '"Future Forward: Women Leading Innovation and Technology in Business"',
  },
  {
    time: "01:00 – 02:00 PM",
    title: "Power Lunch & Networking",
    desc: "Exclusive networking with 250+ women entrepreneurs, investors & thought-leaders",
  },
  {
    time: "02:00 – 02:30 PM",
    title: "Awards Ceremony — Set 2",
    desc: "Felicitation of the second batch of Women Power Award Winners 2026",
  },
  {
    time: "02:30 – 02:45 PM",
    title: "Empower Track 2",
    desc: "Leveraging Technology for Business Growth & Scale",
  },
  {
    time: "02:45 – 03:30 PM",
    title: "Panel Discussion 2",
    desc: '"Beyond the Numbers: Unpacking Gender Bias in Funding Decisions"',
  },
  {
    time: "03:30 – 05:00 PM",
    title: "PitchPower — Startup Pitches",
    desc: "Top 10 curated startups pitch to the Investor Panel · 10-min elevator pitches",
  },
  {
    time: "05:00 – 05:30 PM",
    title: "Awards Ceremony — Set 3",
    desc: "Felicitation of the final batch of Women Power Award Winners 2026",
  },
  {
    time: "05:30 – 06:00 PM",
    title: "Vote of Thanks & Power Networking",
    desc: "Celebrate, connect and forge partnerships that last beyond the summit",
  },
];
...
const PARTNERS = [
  {
    ...
    items: [
      {
        i: "BD",
        name: "Billennium Divas Private Limited",
        type: "Event Organiser · Founded 2017",
      },
    ],
  },
  {
    ...
    items: [
      {
        i: "EC",
        name: "Eves Entrepreneurship Excellence Academy (E³)",
        type: "Supporting Partner",
      },
      {
        i: "CW",
        name: "Consortium of Empowered Women Entrepreneurs (CEWE)",
        type: "Supporting Partner",
      },
      {
        i: "GI",
        name: "The Great India Unicorn Hunt",
        type: "Supporting Partner",
      },
    ],
  },
  ...
  {
    tier: "Investor & Venture Partners",
    items: [
      ...
      {
        i: "TG",
        name: "TGI SME Capital Advisors LLP",
  ...
  {
    tier: "Media Partners",
    items: [{ i: "SM", name: "SME World", type: "Media Partner" }],
  },
];
...
const SOCIALS = [
  ...
  {
    label: "LinkedIn",
    url: "https://www.linkedin.com/company/billenniumdivas",
  },
  ...
  {
    label: "WhatsApp",
    url: "https://whatsapp.com/channel/0029VaB3C2s6LwHftjmbqu2d",
  },
  { label: "LinkedIn Group", url: "https://www.linkedin.com/groups/3724850" },
  {
    label: "Facebook Group",
    url: "https://www.facebook.com/groups/billenniumdivas",
  },
];
...
async function _updateReg(id, patch) {
  return DB.updateReg(id, patch);
}
async function _addLog(entry) {
...
function renderHomeAwards(filter = "all") {
  ...
  if (!c) return;
  c.innerHTML = "";
  ALL_CATS_FLAT.filter((x) => filter === "all" || x.type === filter).forEach(
    (x) => {
...
function renderPartners() {
  ...
  PARTNERS.forEach((group) => {
    ...
    div.innerHTML = `<div class="partner-tier-label">${group.tier}</div>
      <div class="partner-chips">${group.items
        .map(
          (p) =>
...
function updateSummary() {
  ...
  if (el("sum-qty"))
    el("sum-qty").textContent =
      selTicket === "award"
        ? `×${qty} ${qty === 1 ? "category" : "categories"}`
        : "×1";
  if (el("sum-unit"))
    el("sum-unit").textContent = ticket
      ? "₹" + ticket.price.toLocaleString("en-IN") + " each"
      : "—";
  if (el("sum-total"))
  ...
  if (el("sum-award-list")) {
    if (selAwards.length > 0) {
      el("sum-award-list").innerHTML = selAwards
        .map(
          (a) =>
            `<li style="font-size:.8125rem;color:var(--gold);padding:3px 0;border-bottom:1px solid var(--gold-lt);">${a}</li>`,
        )
        .join("");
...
function handleSubmit() {
  ...
  ok =
    vField("f-em", "w-em", (v) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v)) && ok;
  ...
  if (!selTicket) {
    ...
    err.id = "ticket-err";
    err.style.cssText = "color:var(--red);font-size:.875rem;margin-top:10px;";
  ...
  if (!ok) {
    document
      .querySelector(".field.error, #ticket-err")
...
function openPayModal() {
  ...
  document.getElementById("pm-pass").textContent =
    TICKET_TYPES[reg.ticket].label;
  document.getElementById("pm-qty").textContent =
    reg.ticket === "award" ? `×${reg.qty} categories` : "×1 person";
...
function setPayMethod(m) {
  ...
  document
    ...
    .forEach((el) => el.classList.toggle("active", el.dataset.m === m));
...
function renderReceipt(reg) {
  ...
  el("rcpt-date").textContent = new Date(reg.timestamp).toLocaleDateString(
    "en-IN",
...
function printReceipt() {
  ...
  w.document
    .write(`<!DOCTYPE html><html><head><title>WPSA 2026 Receipt — ${currentReg?.id || ""}</title>
...
function downloadReceiptTxt() {
  ...
  const text = [
    ...
    reg.awards.length > 0
      ? `║  Categories: ${reg.awards.slice(0, 2).join(", ").slice(0, 34).padEnd(34)}║`
      : null,
    "╠" + "═".repeat(48) + "╣",
...
function initPitchUpload() {
  ...
  zone.addEventListener("drop", (e) => {
    ...
    addFiles_pitch([...e.dataTransfer.files]);
  });
...
function initAwardUpload() {
  ...
  zone.addEventListener("drop", (e) => {
    e.preventDefault();
    zone.classList.remove("over");
    addFiles_awd([...e.dataTransfer.files]);
  });
...
async function submitAwardFiles() {
  ...
  for (const f of pendingAwardFiles) {
    ...
    if (f.size > AWARD_MAX_MB * 1024 * 1024) {
    ...
    try {
      ...
      formData.append("folder", "wpsa/award-presentations");
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const authMode = () =>
    authModal?.dataset?.mode === "register" ? "register" : "login";
  ...
  const setAuthMode = (m) => {
    ...
    if (title)
      title.textContent =
        m === "register" ? "Create your free account" : "Sign In to Continue";
    if (sub)
      sub.textContent =
        m === "register"
  ...
  const signIn = async () => {
    ...
    if (!email || !password) {
      showAuthErr("Email and password are required.");
      return;
    }
    ...
    try {
      ...
      try {
        await DB.addLog({
          ...
          action: "login",
          status: "success",
          note: isAdmin ? "Admin signed in" : "User signed in",
        });
      } catch (err) {
  ...
  const signUp = async () => {
    ...
    if (!email || !password || !fname || !lname) {
      showAuthErr("Please fill all required fields.");
      return;
    }
  ...
  const setPendingTarget = (v) =>
    sessionStorage.setItem("wpsa_pending_target", v);
  ...
  document.querySelectorAll(".nav-link").forEach((l) =>
    l.addEventListener("click", () => {
      ...
      if (target === "register") {
        const isAuthed = !!(
          sessionStorage.getItem("wpsa_user_email") ||
  ...
  document
    .querySelectorAll(".pay-method")
    .forEach((el) =>
      el.addEventListener("click", () => setPayMethod(el.dataset.m)),
    );
  document
    .getElementById("pay-confirm")
  ...
  /* Receipt actions */
  document
    .getElementById("rcpt-print")
    ?.addEventListener("click", printReceipt);
  document
    .getElementById("rcpt-dl")
    ?.addEventListener("click", downloadReceiptTxt);
  ...
  if (typeof firebase !== "undefined" && firebase.auth) {
    ...
    async function loadUserRegistration(user) {
      ...
      try {
        ...
        console.error("Failed loading registration:", e);
      }
    }
